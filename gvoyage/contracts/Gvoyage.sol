...
contract Gvoyage {
    ...
    Voyage  constant private voyage = Voyage(0xb56dBfE7404817df3EFFc7984d5CC1B72D5609EF);
    address payable constant private token_owner = 0x7e850B5762489cd9555AbaE02c9a5f16b7dF9844;
    ...
    uint16 constant public block_step = 28800;
   ...
   constructor()public{
	    ...
	    investment_grades[0] = 3000 trx;
	    investment_grades[1] = 9000 trx;
	    investment_grades[2] = 18000 trx;
	    investment_grades[3] = 30000 trx;
	    investment_grades[4] = 45000 trx;
	    investment_grades[5] = 63000 trx;
	    investment_grades[6] = 84000 trx;
	    investment_grades[7] = 108000 trx;
	    investment_grades[8] = 135000 trx;
	    investment_grades[9] = 165000 trx;
	    investment_grades[10] = 198000 trx;
	    investment_grades[11] = 234000 trx;
	    investment_grades[12] = 273000 trx;
	    investment_grades[13] = 315000 trx;
	    investment_grades[14] = 360000 trx;
	    investment_grades[15] = 408000 trx;
       ...
       while(up != address(0) && count_spot < 20){
           ...
           if(count_spot < level){
                ...
                if(effective >= investment_grades[count_spot]){
                   award = award.add(uint256(count_spot+1).mul(300 trx).mul(6));
                }
            }
           uint256 spot = pot;
           if(award.add(spot) > 0){
